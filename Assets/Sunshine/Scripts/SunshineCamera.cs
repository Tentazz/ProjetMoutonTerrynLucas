...
public class SunshineCamera : MonoBehaviour
{
...
#if !UNITY_3_0 && !UNITY_3_0_0 && !UNITY_3_1 && !UNITY_3_2 && !UNITY_3_3 && !UNITY_3_4 && !UNITY_3_5 && !UNITY_4_0 && !UNITY_4_0_1 && !UNITY_4_1 && !UNITY_4_2 && !UNITY_4_3 && !UNITY_4_4 && !UNITY_4_5
	...
	void RenderCascades()
	{
		...
		if(!NeedsRefresh(shadowBoundingSphere.origin))
			return;
		bool tweakTerrain = (Sunshine.Instance.TerrainLODTweak > 0f);
		if(tweakTerrain)
		{
		...
		for(int cID = 0; cID < Sunshine.Instance.CascadeCount; cID++)
		{
			...
			Shader.SetGlobalVector("sunshine_DepthBiases", new Vector2(Sunshine.Instance.ShadowBias, Sunshine.Instance.ShadowSlopeBias(cID)));
	...
	void ConfigureShaders()
	{
		...
		*/
		...
		Vector3 sunEyePos = Sunshine.Instance.SunLightCamera.transform.InverseTransformPoint(worldEyeOrigin);
		Vector3 sunEyeFarPos00 = Sunshine.Instance.SunLightCamera.transform.InverseTransformPoint(worldEyeFar00);
		Vector3 sunEyeFarPos10 = Sunshine.Instance.SunLightCamera.transform.InverseTransformPoint(worldEyeFar10);
		Vector3 sunEyeFarPos01 = Sunshine.Instance.SunLightCamera.transform.InverseTransformPoint(worldEyeFar01);
